           ...
           private void LoadKamera()
        {
           ...
           void Finalvideo_NewFrame(object sender, NewFrameEventArgs eventArgs)
           {
               ...
               if (radioButton5.Checked)
               {
                   ...
                   EuclideanColorFiltering filter = new EuclideanColorFiltering();
                   // set center color and radius
                   filter.CenterColor = new RGB(Color.FromArgb(255, 125, 115));
                   filter.Radius = 100;
                   // apply the filter
                   filter.ApplyInPlace(image1);
               ...
               if (radioButton4.Checked)
               {
                   ...
                   foreach (Rectangle recs in rect)
                   {
                       if (rect.Length > 0)
                       {
                           ...
                           if (objectX < 320 && objectY < 160)
                           {
                               Console.WriteLine("Soldaki Servoyu Yukarıya Hareket Ettir");
                               serialPort1.Write("1");
                           }
                           if (objectX < 320 && objectY > 160 && objectY < 320)
                           {
                               Console.WriteLine("Soldaki Servoyu Orta Konuma Getir");
                               serialPort1.Write("2");
                           }
                           if (objectX < 320 && objectY > 320 && objectY < 480)
                           {
                               Console.WriteLine("Soldaki Servoyu Aşağı Hareket Ettir");
                               serialPort1.Write("3");
                           }
                           if (objectX > 320 && objectY < 160)
                           {
                               Console.WriteLine("Sağdaki Servoyu Yukarıya Hareket Ettir");
                               serialPort1.Write("4");
                           }
                           if (objectX > 320 && objectY > 160 && objectY < 320)
                           {
                               Console.WriteLine("Sağdaki Servoyu Orta Konuma Getir");
                               serialPort1.Write("5");
                           }
                           if (objectX > 320 && objectY > 320 && objectY < 480)
                           {
                               Console.WriteLine("Sağdaki Servoyu Aşağı Hareket Ettir");
                               serialPort1.Write("6");
                           }
